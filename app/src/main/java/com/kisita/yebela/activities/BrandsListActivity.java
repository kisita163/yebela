...
import com.kisita.yebela.utility.BrandsAdapter;
import com.kisita.yebela.utility.ResultAdapter;

public class BrandsListActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    private String TAG = getClass().getName();
    private ListView searchList;
    private TextView mNoResult;
    private String selection = PlacesContract.PlaceEntry.COLUMN_NAME+ " LIKE ? ";
    private BrandsAdapter mMainAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMainAdapter = new BrandsAdapter(this);
