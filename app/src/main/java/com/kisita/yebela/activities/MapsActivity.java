...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String currLatitude = sharedPref.getString(this.getString(R.string.latitude),"-4.4011293");
        String currLongitude = sharedPref.getString(this.getString(R.string.longitude),"15.2527045");
